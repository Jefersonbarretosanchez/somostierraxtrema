...
<div class="contenedor-login">
    ...
    <div class="contenedor-texto">
        ...
        <div class="contenedor-form">
            ...
            <p class="descripcion text-center">¿Tienes alguna duda?Quieres saber mas de nuestros planes.<br>Contactanos, nuestro equipo estara feliz de atenderte</p>
            <!-- tabs -->

            <!-- Formulario Login -->
            <form action="./bd/formulario.php" method="POST" id="formContact" class="formulario  active">
                <div class="error-text">
                    <p>Aqui estan los errores</p>
                </div>
                <input type="text" placeholder="Nombre Completo" class="input-text" name="nombre" id="nombre" autocomplete="off">

                <input type="text" placeholder="Correo Electronico" class="input-text" name="correo" id="correo" autocomplete="off">

                <input type="number" placeholder="Telefono Contacto" class="input-text" name="telefono" id="telefono" autocomplete="off">
